...
public class NetherAdditionsFoodComponents {
    ...
    public static final FoodComponent LAVACANTH = new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 900), 1f).build();
